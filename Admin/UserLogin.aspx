<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserLogin.aspx.cs" Inherits="RoboNewser.Admin.UserLogin" %>

<%@ Register Src="~/UserControls/AdminLogin.ascx" TagName="AdminLogin" TagPrefix="UC" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>RoboNewser Administration</title>
...
<body>
    ...
    <div id="wrap">
            ...
            <div class="main">
                ...
                <div class="pageBody">
                    <div class="homeBox" style="text-align: center;margin-right:100px;margin-top:30px;margin-bottom:30px;">
                        <UC:AdminLogin runat="server" ID="Login1" />
                        <br class="clearfloat" />
                    </div>
                </div>
            </div>
        ...
        <div class="homeLable">
            ...
            <br />
            <span id="ctl00_lblFooter2">طراحی و پیاده سازی:</span> <a href="http://RoboNewser.com"
