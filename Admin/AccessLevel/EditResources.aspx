<%@ Page Language="C#" StylesheetTheme="Edit" MasterPageFile="~/Admin/Main.master" AutoEventWireup="true" Inherits="Resources_EditResources" Title="Resources" Codebehind="EditResources.aspx.cs" %>
                                                ...
                                                <div class="cHeaderEditMain">
                                                    <table align="left" width="150" dir="ltr">
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:ImageButton ID="imgBtnView" runat="server" ImageUrl="~/images/View.gif" />
                                                            </td>
                                                            <td class="cSepVer">
                                                            </td>
                                                            <td>
                                                                <asp:ImageButton ID="imgBtnEdit" runat="server" ImageUrl="~/images/Edit.gif" />
                                                            </td>
                                                            <td class="cSepVer">
                                                            </td>
                                                            <td>
                                                                <asp:ImageButton ID="imgBtnPrint" runat="server" ImageUrl="~/images/Print.gif" />
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </div>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <tr>
                                                                        <td class="cCtrl">
                                                                            <AKP:ExTextBox jas="1" ID="txtName"  CssClass="cMultiLine" TextMode="MultiLine" MaxLength="1000"  runat="server"/>
                                                                        </td>
                                                                        <td class="cLabel">
                                                                    ...
                                                                    <tr>
                                                                        <td class="cCtrl">
                                                                            <AKP:ExTextBox jas="1" ID="txtEngName"  CssClass="cMultiLine" TextMode="MultiLine" MaxLength="1000"  runat="server"/>
                                                                        </td>
                                                                        <td class="cLabel">
                                                                    ...
                                                                    <tr>
                                                                        <td class="cCtrl">
                                                                            <AKP:ExTextBox jas="1" ID="txtEditPath"  CssClass="cMultiLine" TextMode="MultiLine" MaxLength="200"  runat="server"/>
                                                                        </td>
                                                                        <td class="cLabel">
