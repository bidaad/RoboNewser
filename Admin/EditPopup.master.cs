...
public partial class Admin_EditPopup : System.Web.UI.MasterPage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        script1.Attributes.Add("src", this.ResolveClientUrl("~/Admin/js/main.js"));
        ...
        script2.Attributes.Add("src", this.ResolveClientUrl("~/Admin/js/farsi.js"));
        ...
        script3.Attributes.Add("src", this.ResolveClientUrl("~/Admin/js/Browse.js"));
        ...
        script4.Attributes.Add("src", this.ResolveClientUrl("~/Admin/js/PersianDate.js"));
        ...
        script6.Attributes.Add("src", this.ResolveClientUrl("~/Admin/js/Lookup.js"));
