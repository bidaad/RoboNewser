<%@ Page Language="C#" StylesheetTheme="Edit" MasterPageFile="~/Admin/EditPopup.master"
    AutoEventWireup="True" Inherits="NewsNewsFlows_EditNewsNewsFlows"
    Title="NewsNewsFlows" Codebehind="EditNewsNewsFlows.aspx.cs" %>
        ...
        <tr>
            <td>
                <table cellpadding="0" cellspacing="0" width="90%" class="cMainEditTable">
                    <tr>
                        <td>
                            <AKA:MsgBox ID="msgBox" runat="server" CssClass="cError" />
                        </td>
                    </tr>
                    <div>
                                        ...
                                        <tr>
                                            <td>
                                                <table class="EditRow">
                                                    <tr>
                                                        <td class="cCtrl">
                                                            <AKA:Lookup jas="1" ID="lkpNewsFlowCode" BaseID="NewsFlows" runat="server" />
                                                        </td>
                                                        <td class="cLabel">
                                                            <asp:Label ID="lblNewsFlowCode" runat="server" Text="جريان خبري:"></asp:Label>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
